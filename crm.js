...
function create_Tr_Td(x){
  ...
  emp_td7.innerHTML = '<a class="edt btn btn-warning p-1" onClick="onEdit(this)">Edit</a>  / <a class="dlt btn btn-danger p-1" onClick="onDelete(this)">Delete</a>';
}
...
function onEdit(y){
  ...
  //var selecteventbtn = document.querySelector("a.edt");
    ...
    document.querySelector(".empemail").value = selectedRow.cells[2].innerHTML;
